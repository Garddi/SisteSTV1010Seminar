...
- Pauser er essensielle, sosialt, energimessig, og læringsmessig

![havefuninsuffering](presImg/denjipower.gif)
...
- Alt henger faktisk sammen med alt

. . .

```{r, echo=FALSE, out.width="20%"}
knitr::include_graphics("presImg/gro.jpg")
```
...
## Passivt vs aktivt språk

- Vi er sjeldent interessert i *hvem* som gjør noe, heller hvem som mottar eller opplever konsekvensene av den handlingen
- Passiv skriving er viktig når:
  - Du vil fokusere på tingen som blir påvirket
  - Det er ikke viktig hvem som gjorde det
  - Du vil være upersonlig eller formell
- Form passiv stemme ved:
  - Gjøre objektet i en aktiv stemme til subjektet
  - Bruk preteritum eller perfektum
  
## Generelt om språk og det å se over

- Sikre at man ikke gjentar seg
- Ikke gjenta formuleringer
- Sikre at du gir andre argumenter en "fair chance"
  - Balanser synspunkt
...
- https://sokogskriv.no/kjeldebruk/korleis-skal-ein-referere.html
